...
def main():
    ...
    if choice == "Home":
        ...
        webrtc_streamer(key="example",video_processor_factory = VideoProcessor,media_stream_constraints={"video": True, "audio": False},async_processing=True, mode=WebRtcMode.SENDRECV)
        ...
        if uploaded_file is not None:
            ...
            if st.button("Process Image"):                
                ...
                st.image(processed_image1, caption='Processed Image', use_column_width=True)
